...
<body class="container mt-4">
    <h2>ตะกร้าสินค้า</h2>
    <a href="index.php" class="btn btn-secondary mb-3">← กลับไปเลือกสินค้า</a> <!-- TODO: หน้ index -->
    <?php if (count($items) === 0): ?>
        <div class="alert alert-warning">ยังไม่มีสินค้าในตะกร้า</div> <!-- TODO: ข้อความกรณีตะกร้าสินค้าว่าง -->
    <?php else: ?>
